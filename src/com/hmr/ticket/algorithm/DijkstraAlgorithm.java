package com.hmr.ticket.algorithm;
 ...
 * 
 *         This is the algorithm to find the shortest path between two stations
 *
 */
public class DijkstraAlgorithm {
	...
	private int getDistance(Vertex node, Vertex target) {
		for (Edge edge : edges) {
			if ((edge.getSource().equals(node) && edge.getDestination().equals(
					target))
					|| (edge.getDestination().equals(node) && edge.getSource()
							.equals(target))) {
